...
const UniGraphicSelector = ({ value, onUniversityChange }) => {
  ...
  return (
    <div className='relative flex items-center'>
      {/* T-73: dark:text-*, no bg-* propio - esta fila vive sobre la
          cabecera de Layout.jsx (dark:bg-base-200), no tiene su propia
          superficie. */}
      <label
        htmlFor='university'
        className='block text-sm font-medium text-gray-700 dark:text-base-content mr-2'
      >
        <IoLocationSharp className='inline-block w-5 h-5 text-gray-500 dark:text-base-content/70' />
      </label>
      <div className='relative flex-grow'>
        ...
        {isOpen && (
          <ul className='absolute z-10 mt-1 w-full bg-base-100 text-base-content border border-base-300 rounded-md shadow-lg max-h-60 overflow-y-auto'>
