  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold">Problema que resolvemos</h2>
      ...
      <section className="bg-[#F2F2F2] py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold">¿Qué es Mercampus?</h2>
          <p className="text-xl mt-4">
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold">¿Qué eres capaz de hacer?</h2>
          <p className="text-xl mt-4">
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold">Categorías principales</h2>
          <div className="flex justify-center gap-8 mt-8">
      ...
      <section className="bg-[#F2F2F2] py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold">Comunidad y testimonios</h2>
          <div className="flex justify-center gap-8 mt-8">
            <div className="w-1/3 p-4 border rounded-lg">
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold">Crecimiento y visión</h2>
          <p className="text-xl mt-4">
            “Millones de estudiantes en LATAM tienen esta necesidad. Mercampus está aquí para transformar la forma en que nos conectamos dentro del campus.”
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#F2F2F2] py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold">Sé parte de Mercampus. Únete y empieza a conectar hoy.</h2>
          <div className="flex justify-center gap-4 mt-8">
            <Link href="/auth/register" className="bg-[#FF7622] text-white py-3 px-8 inline-block rounded-lg text-lg font-semibold">
              Regístrate ahora
            </Link>
            <a href="#" className="bg-gray-800 text-white py-3 px-8 inline-block rounded-lg text-lg font-semibold">
